    ...
    private boolean dozeInsteadOfWake(@DozeLog.Reason int reason) {
        switch (reason) {
            case DozeLog.REASON_SENSOR_PICKUP:
                return mConfig.pickupAmbient(UserHandle.USER_CURRENT);
            case DozeLog.REASON_SENSOR_DOUBLE_TAP:
                return mConfig.doubleTapAmbient(UserHandle.USER_CURRENT);
            case DozeLog.REASON_SENSOR_TAP:
                return mConfig.tapAmbient(UserHandle.USER_CURRENT);
        }
        return false;
    }
